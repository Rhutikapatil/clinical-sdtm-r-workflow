...
├── outputs/              # Generated XPT, RDS, QC report; ignored by Git
├── run_demo.R
├── .gitignore
└── README.md
```
...
All inputs are generated by code in this repository. Do not add original study datasets, reference outputs, instructor specifications, protocols, or unpublished study material to this public portfolio repository.
